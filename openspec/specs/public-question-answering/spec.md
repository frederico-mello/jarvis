...
Permitir que funcionários e alunos do ICT-SJC façam perguntas em português e recebam respostas fundamentadas exclusivamente em fontes institucionais, com citações verificáveis e indicação clara quando não houver evidência suficiente.
