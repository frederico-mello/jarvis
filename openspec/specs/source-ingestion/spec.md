...
Coletar periodicamente páginas públicas do site institucional e processar documentos enviados por servidores autorizados, detectando alterações, evitando duplicatas e preservando versões históricas.
