...
Modelar o conhecimento institucional do ICT-SJC como um grafo de entidades e relações, armazenando chunks, embeddings, índices de busca e proveniência de cada fato extraído.
